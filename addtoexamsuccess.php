...
<center>
  ...
  $query = "INSERT INTO exam_qualifications VALUES('$year_from', '$year_to', '$roll_no', '$name', '$exam', '$imageData', '$imageType')";
...
<a href="naacsearch.php"><button class = "button1" style = "top:auto;left:41.5%;">Exam database search</button></a>
<p><br></p>
</div>
<?php 
  }
