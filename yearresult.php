...
<?php
  $link = mysqli_connect("localhost", "id18380925_admin", "C}AHF-v/}Mt7}]HE", "id19228304_id18380925_naac_criterion5");
    ...
    $yearto = $_POST['yearto'];
    $query = "SELECT * FROM exam_qualifications WHERE Academic_year_from >= '$yearfrom' AND Academic_year_to <= '$yearto' ORDER BY Academic_year_from";
    $req = mysqli_query($link, $query) or die(mysqli_error($link));
    if ($req->num_rows > 0){
        ?>
    <i><br><p style = "font-family: Georgia;color:rgb(255, 234, 138);font-size:28px;font-weight:0;text-shadow: 1px 1px 2px black, 0 0 25px blue, 0 0 5px darkblue;text-align:center;">The examination details for <?php echo "$yearfrom - $yearto";?> are :</p></i><br><br></div>
    <table>
...
<a href="naacsearch.php"><button class = "button1" style = "top:auto;left:30%;">Search Again!</button></a>
<a href="scoressearch.php"><button class = "button" style = "top:auto;left:51%;">View Scores</button></a><br><br>
<p><br></p>
  </div>
</center>
</body>
