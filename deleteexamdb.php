...
<head>
    ...
    <title>Exam Qualifications database</title>
...
<div class = "blurtext" style = "font-family: Times New Roman, Times, serif;color: #FFFFFF;font-size:3.57vw;font-weight:700;left:22%;top:20%;text-shadow: 1px 1px 2px black, 0 0 25px red, 0 0 5px black;text-align:center;float:left;">
<i>Fill the student details to delete the record!</i></div>
<form method = "POST" action="deleteexamdbsuccess.php" class="form">
    ...
    <input type="text" name="exam" placeholder="Exam Name" class = "blurtext" style="font-size:20px;top:55%;left:35.5%;height:40px;padding:24px;border-radius:20px;text-align:center;width:30%;" class = "form">
    <input type = "submit" value = "Submit" class = "button1" style ="left:41%;top:70%;"> 
</form>
<?php
    }
    else{?>
