...
<?php
  $link = mysqli_connect("localhost", "id18380925_admin", "C}AHF-v/}Mt7}]HE", "id19228304_id18380925_naac_criterion5");
    $query = "SELECT * FROM higher_education ORDER BY Academic_year_from";
    $req = mysqli_query($link, $query) or die(mysqli_error($link));
    if ($req->num_rows > 0){
    ?>
    <i><br><p style = "font-family: Georgia;color:white;font-size:28px;font-weight:0;text-shadow: 1px 1px 2px red, 0 0 25px pink, 0 0 5px red;text-align:center;">The details of students enrolled in higher educational programmes are :</p></i><br><br></div>
    <table>
...
<a href="allotmentsearch.php"><button class = "button1" style = "top:auto;left:41%;">View Allotments</button></a><br><br>
<p><br></p>
</div>
</center>
</body>
