...
<?php
    ...
    $query = "UPDATE studentlogin SET Student_password = '$pass' WHERE Student_name = '$name' AND Student_email = '$email'";
    ...
    if(mysqli_affected_rows($link)>0){
      ...
      <?php 
          ...
          ?>
          <i><br><p style = "font-family: Georgia;color:rgb(255, 234, 138);font-size:28px;font-weight:0;text-shadow: 1px 1px 2px black, 0 0 25px blue, 0 0 5px darkblue;text-align:center;">Password reset failed, please try again</p></i><br><br></div>
       <?php }?>
