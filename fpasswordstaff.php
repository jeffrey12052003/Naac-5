...
<form method = "POST" action="fpasswordstaffsuccess.php" class="form">
    <input type="text" name="email" placeholder="Staff Email" class = "blurtext" style="font-size:20px;top:38%;left:36%;height:40px;padding:24px;border-radius:20px;text-align:center;width:30%;" class = "form">
    <input type="text" name="name" placeholder="Staff Name" class = "blurtext" style="font-size:20px;top:50%;left:36%;height:40px;padding:24px;border-radius:20px;text-align:center;width:30%;" class = "form">
