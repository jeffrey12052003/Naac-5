...
<?php
  $link = mysqli_connect("localhost", "id18380925_admin", "C}AHF-v/}Mt7}]HE", "id19228304_id18380925_naac_criterion5");
    $name = $_POST['name'];
    $query = "DELETE FROM higher_education WHERE Student_name LIKE '$name%'";
...
<a href="deletefromdbfp.php"><button class = "button1" style = "top:auto;left:28%;">Delete Again!</button></a>
