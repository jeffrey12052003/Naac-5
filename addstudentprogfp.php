...
<i>Select your choice</i></div>
<a href="addtoexam.php"><button class = "button1" style= "top: 40%; left: 53%;">Exam database</button></a>
<a href="addtohedb.php"><button class = "button" style= "top: 40%; left: 29%;">Higher education</button></a>
</body>
<?php
    }
    else
